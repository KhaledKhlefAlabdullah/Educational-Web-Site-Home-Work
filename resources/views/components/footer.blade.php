        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6 footer-contact">
                    <h3>{{__("knowledge")}}</h3>
                    <p>
                        {{__("Liberty Street")}} <br>
                        {{__("Azaz")}}<br>
                        {{__("Syria")}} <br><br>
                        <strong>{{__("Phone")}}:</strong> +352681590692<br>
                ...
                <div class="col-lg-2 col-md-6 footer-links">
                    ...
                    <ul>
                        <li><i class="bx bx-chevron-right"></i> <a href="{{route('blade.home')}}">{{__("Home")}}</a></li>
                        <li><i class="bx bx-chevron-right"></i> <a href="{{route('blade.about')}}">{{__("About")}}</a></li>
